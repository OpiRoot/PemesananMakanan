...
import com.example.acer.pemesananmakanan.Adapter.NoteAdapter;
...
import static com.example.acer.pemesananmakanan.FormAddUpdateActivity.REQUEST_UPDATE;
...
public class Order extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Catatan Pemesanan");
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.fab_add){
            Intent intent = new Intent(Order.this, FormAddUpdateActivity.class);
    ...
    private class LoadNoteAsync extends AsyncTask<Void, Void, ArrayList<Note>> {
        ...
        protected void onPostExecute(ArrayList<Note> notes) {
            ...
            if (list.size() == 0){
                showSnackbarMessage("Tidak ada data pesanan saat ini");
            }
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == FormAddUpdateActivity.REQUEST_ADD){
            if (resultCode == FormAddUpdateActivity.RESULT_ADD){
                new LoadNoteAsync().execute();
                showSnackbarMessage("Item pesanan berhasil ditambahkan");
            ...
            if (resultCode == FormAddUpdateActivity.RESULT_UPDATE) {
                new LoadNoteAsync().execute();
                showSnackbarMessage("Item pesanan berhasil diubah");
                ...
                adapter.setListNotes(list);
                adapter.notifyDataSetChanged();
                showSnackbarMessage("Item pesanan berhasil dihapus");
            }
        }
    }
